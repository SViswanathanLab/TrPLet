...
#df = pd.read_csv("/mnt/storage/home/yc638/0327_drost/data/merged_TCGA_geneLevel_CountMatrix.tsv.gz", compression='gzip', header=0, sep='\t', quotechar='"')
...
df2 = pd.read_csv("/mnt/storage/home/yc638/0327_drost/data/gene_count_matrix.txt", sep="\t")
...
# for a in df_ids:
#     g_id = a.split("|")[1]
#     df_ids_proc.append(g_id.split(".")[0])
